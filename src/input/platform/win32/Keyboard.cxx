			...
			case WM_KEYUP:
				if(Keyboard::Listener::onKey)
				{
					...
					switch(data.vkCode)
					{
						case VK_LCONTROL:
						case VK_RCONTROL:
							Keyboard::Listener::onKey(axl::game::input::KEY_CONTROL, is_down);
							break;
						case VK_LSHIFT:
						case VK_RSHIFT:
							Keyboard::Listener::onKey(axl::game::input::KEY_SHIFT, is_down);
							break;
						case VK_LMENU:
						case VK_RMENU:
							Keyboard::Listener::onKey(axl::game::input::KEY_ALT, is_down);
							break;
						case VK_LWIN:
						case VK_RWIN:
							Keyboard::Listener::onKey(axl::game::input::KEY_CMD, is_down);
							break;
					}
