			...
			case WM_LBUTTONUP:
				{
					...
					if(Mouse::Listener::onMouse)
						Mouse::Listener::onMouse(axl::game::input::MBTN_LEFT, data.pt.x, data.pt.y, (wparam == WM_LBUTTONDOWN));
				}
				return 0;
			case WM_RBUTTONDOWN:
			case WM_RBUTTONUP:
				{
					MSLLHOOKSTRUCT data = *((MSLLHOOKSTRUCT*)lparam);
					if(Mouse::Listener::onMouse)
						Mouse::Listener::onMouse(axl::game::input::MBTN_RIGHT, data.pt.x, data.pt.y, (wparam == WM_RBUTTONDOWN));
				}
				return 0;
			case WM_MBUTTONDOWN:
			case WM_MBUTTONUP:
				{
					MSLLHOOKSTRUCT data = *((MSLLHOOKSTRUCT*)lparam);
					if(Mouse::Listener::onMouse)
						Mouse::Listener::onMouse(axl::game::input::MBTN_MIDDLE, data.pt.x, data.pt.y, (wparam == WM_MBUTTONDOWN));
				}
				return 0;
			case WM_XBUTTONDOWN:
			case WM_XBUTTONUP:
				{
					MSLLHOOKSTRUCT data = *((MSLLHOOKSTRUCT*)lparam);
					if(Mouse::Listener::onMouse)
						Mouse::Listener::onMouse(axl::game::input::MBTN_EXTRA, data.pt.x, data.pt.y, (wparam == WM_XBUTTONDOWN));
				}
				return 0;
			case WM_MOUSEMOVE:
				{
